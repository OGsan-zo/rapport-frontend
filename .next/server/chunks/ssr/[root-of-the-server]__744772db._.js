...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},46058,(a,b,c)=>{"use strict";function d(a){if("function"!=typeof WeakMap)return null;var b=new WeakMap,c=new WeakMap;return(d=function(a){return a?c:b})(a)}c._=function(a,b){if(!b&&a&&a.__esModule)return a;if(null===a||"object"!=typeof a&&"function"!=typeof a)return{default:a};var c=d(b);if(c&&c.has(a))return c.get(a);var e={__proto__:null},f=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var g in a)if("default"!==g&&Object.prototype.hasOwnProperty.call(a,g)){var h=f?Object.getOwnPropertyDescriptor(a,g):null;h&&(h.get||h.set)?Object.defineProperty(e,g,h):e[g]=a[g]}return e.default=a,c&&c.set(a,e),e}},14548,a=>{"use strict";let b="/api/auth";a.s(["authService",0,{checkAuth:async()=>{let a=await fetch("/api/auth/me",{method:"GET",credentials:"include",headers:{"Content-Type":"application/json"}}),b=await a.json();if(!a.ok)throw Error(b.message||"Erreur lors de la connexion");return b.user},login:async a=>{let c=await fetch(`${b}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),d=await c.json();if(!c.ok)throw Error(d.message||d.error||"Erreur lors de la connexion");return d},logout:async()=>{await fetch(`${b}/logout`,{method:"POST"}),await new Promise(a=>setTimeout(a,300))}}])},72046,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(14548),e=a.i(50944),f=a.i(6704);let g=(0,c.createContext)(void 0);a.s(["UserProvider",0,({children:a})=>{let[h,i]=(0,c.useState)(null),[j,k]=(0,c.useState)(!0),l=(0,e.useRouter)(),m=async()=>{k(!0);try{let a=await d.authService.checkAuth();i(a)}catch(a){i(null)}finally{k(!1)}},n=async()=>{k(!0);try{await d.authService.logout(),i(null),l.push("/login")}catch(a){f.default.error("Erreur lors de la déconnexion"),i(null),l.push("/login")}finally{k(!1)}};return(0,c.useEffect)(()=>{m()},[]),(0,b.jsx)(g.Provider,{value:{user:h,loading:j,setUser:i,logout:n,refreshUser:m},children:a})},"useUser",0,()=>{let a=(0,c.useContext)(g);if(!a)throw Error("useUser doit être utilisé à l'intérieur d'un UserProvider");return a}])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__744772db._.js.map