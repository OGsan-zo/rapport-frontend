...
"[project]/src/features/auth/services/authService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/auth/contexts/UserContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UserProvider = ({ children })=>{
    ...
    const fetchUser = async ()=>{
        setIsLoading(true);
        try {
            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].checkAuth();
            setUser(userData);
        } catch (error) {
            setUser(null);
        } finally{
    ...
    const logout = async ()=>{
        setIsLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].logout();
            setUser(null);
            router.push("/login"); // Force la redirection après le nettoyage de l'état
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Erreur lors de la déconnexion");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(UserContext.Provider, {
        ...
        fileName: "[project]/src/features/auth/contexts/UserContext.tsx",
        lineNumber: 70,
        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a81c2402._.js.map