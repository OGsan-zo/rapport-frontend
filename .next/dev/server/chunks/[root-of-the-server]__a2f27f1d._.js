...
"[project]/src/app/api/rapports/OS/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, context) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$callApi$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["callApiPut"])(req, `rapports/OS/${id}`, requiredFields);
}
async function DELETE(request, context) {
    const { id } = await context.params;
    // On construit l'url "rapports/1" dynamiquement
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$callApi$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["callApiDelete"])(request, `/rapports/OS/${id}`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__a2f27f1d._.js.map