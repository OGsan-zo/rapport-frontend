...
"[project]/src/features/auth/contexts/UserContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UserProvider = ({ children })=>{
    ...
    const fetchUser = async ()=>{
        setIsLoading(true);
        try {
            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].checkAuth();
            setUser(userData);
        } catch (error) {
            setUser(null);
        } finally{
    ...
    const logout = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Erreur lors de la déconnexion");
...
_s1(UserProvider, "8WEfEbosx3NfLBPRVajZSQS3udc=", false, function() {
    return [
...
//# sourceMappingURL=_40790d9d._.js.map