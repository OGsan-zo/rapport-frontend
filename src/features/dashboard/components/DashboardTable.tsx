...
export const DashboardTable: React.FC<DashboardTableProps> = ({ 
    ...
    const statusClasses: Record<string, string> = {
        ...
        BROUILLON: "text-amber-800 bg-amber-50 border-amber-300",
    };
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {isLoading ? (
                            ...
                            rapports.map((rapport) => {
                                const statutStyle = statusClasses[rapport.statut || "BROUILLON"] || "text-slate-600 bg-slate-50 border-slate-200";
                                ...
                                return (
                                    <tr key={rapport.id} className="hover:bg-slate-50/40 transition-colors group">
                                        ...
                                        {/* J'ai rajouté la cellule de statut qui manquait ! */}
